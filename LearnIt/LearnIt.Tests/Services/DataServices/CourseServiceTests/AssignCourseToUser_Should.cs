...
namespace LearnIt.Tests.Services.DataServices.CourseServiceTests
{
    ...
    public class AssignCourseToUser_Should
    {
        ...
        //    //Act
        //    await courseService.AssignCourseToUser(courseId, username, date, status);
        //    //Assert
        ...
        //    CourseService courseService = new CourseService(dbContextMock.Object);
        //    //Act && Assert
        //    await Assert.ThrowsExceptionAsync<ArgumentException>(() => courseService.AssignCourseToUser(courseId, username, date, status));
        //}
    }
}
